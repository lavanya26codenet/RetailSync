...
public class ViewReceptionistsFrame extends javax.swing.JFrame {
    ...
    // Table Styling
    jtAllEmp.setFont(new Font("Comic Sans MS", Font.PLAIN, 14));
    jtAllEmp.setRowHeight(25);
    jtAllEmp.setGridColor(Color.BLACK);
    jtAllEmp.setSelectionBackground(new Color(173, 216, 230)); // Light Blue
    jtAllEmp.setSelectionForeground(Color.BLACK);
    jtAllEmp.setShowVerticalLines(true);

    // Table Header Styling
    JTableHeader tableHeader = jtAllEmp.getTableHeader();
...
private void styleToggleButton(JToggleButton button, Color bgColor) {
    ...
    private void initComponents() {
        ...
        jtAllEmp.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Emp ID", "Emp Name", "User ID", "UserType", "Salary"
            }
        ) {
    ...
    try
        ...
        tm.setColumnIdentifiers(new Object[]{"Emp ID", "Name","User Id", "Job", "Salary"});
