 ...
 * @author Admin
 */
public class ViewItemsFrame extends javax.swing.JFrame {
...
private void styleToggleButton(JToggleButton button, Color bgColor) {
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ManageStocksFrame moptions = new ManageStocksFrame();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewItemsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewItemsFrame().setVisible(true);
            }
        });
    }
    ...
    try
        ...
        DefaultTableModel tm = (DefaultTableModel)jtViewItems.getModel();
